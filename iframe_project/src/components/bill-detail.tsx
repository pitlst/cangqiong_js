...
export function DetailSection({
    ...
    return (
        <Collapsible defaultOpen={defaultOpen} className={cn('flex min-h-0 flex-col', className)}>
            ...
            <CollapsibleContent className="flex min-h-0 flex-col">{children}</CollapsibleContent>
        </Collapsible>
    )
}
